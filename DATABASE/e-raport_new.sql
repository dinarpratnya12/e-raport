...
--
-- Host: 127.0.0.1
-- Generation Time: 15 Nov 2021 pada 05.20
...
CREATE TABLE `tbl_siswa` (
  `id_siswa` tinyint(10) NOT NULL,
  `nama_siswa` varchar(100) NOT NULL,
  `id_user` tinyint(4) NOT NULL,
  `NIS` tinyint(10) NOT NULL,
  `NISN` tinyint(10) NOT NULL,
  `id_kelas` tinyint(4) NOT NULL,
...
CREATE TABLE `tbl_ta` (
  `id_ta` tinyint(4) NOT NULL,
  `periode_ta` varchar(25) NOT NULL,
  `id_kelas` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(20, 'Hapus Akun Saya', 'nav-icon fa fa-ban', 'user/delete-my-account', 1, 1),
...
--
ALTER TABLE `tbl_siswa`
  MODIFY `id_siswa` tinyint(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_ta`
--
ALTER TABLE `tbl_ta`
  MODIFY `id_ta` tinyint(4) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tbl_user_token`
  MODIFY `id_user_token` mediumint(9) NOT NULL AUTO_INCREMENT;COMMIT;
